                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              if (index < imagesToDisplay.length) {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    addItemController.editImages(context, item);
                                  },
                                  child: Container(
                                    height: screenSize.height * 0.07,
                                    width: screenSize.width * 0.15,
                      ...
                      CustomButton(
                        ...
                        onPress: () {
                          ...
                          if (addItemController.stockAvailable.text
                              .trim()
                              .isNotEmpty) {
                            int additionalStock = int.tryParse(addItemController
                                    .stockAvailable.text
                                    .trim()) ??
                                0;
                          ...
                          AddItemModel updateItem = AddItemModel(
                            itemPic:
                                addItemController.itemPic.value ?? item.itemPic,
                            ...
                            itemCostPrice:
                                addItemController.costPrice.text == ''
                                    ? item.itemCostPrice
                                    : addItemController.costPrice.text.trim(),
                            trackProfit:
                            ...
                            trackLowStock:
                                addItemController.trackLowStock.value == false
                                    ? item.trackLowStock
                                    : addItemController.trackLowStock.value,
                            preventItemSalesWhenOutOfStock: addItemController
                                        .preventItemSalesWhenOutOfStock.value ==
                                    false
                            ...
                            trackExpiry:
                                addItemController.trackExpiry.text == ''
                                    ? item.trackExpiry
                                    : addItemController.trackExpiry.text.trim(),
                            expiryAlert:
                          ...
                          AddItemRepo.instance
                              .editItemData(updateItem)
                              .then((value) {
