      ...
      body: store.storeName == ''
          ? const Center(
              child: Padding(
                ...
                child: Text(
                  'You have no stock to checkout.\n You can add stock from the STOCKS in dashbaord',
                ),
              ),
            )
          : Container(
                          ...
                          if (index == 0) {
                            return Padding(
                              ...
                              child: SizedBox(
                                  ...
                                  //       ),
                                  //       subtitle:
                                  //           CheckOutCategoryQuantityString(
                                  //               alItemsInCategory:
                                  //                   alItemsInCategory),
                                  //     ),
